        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    ...
                    @else
                        <a href="/user/login" class="text-sm text-gray-700 dark:text-gray-500 underline">Patient Login</a>
                        <span class="text-gray-700">||</span>
                        <a href="/doctor/login" class="text-sm text-gray-700 dark:text-gray-500 underline">Doctor Login</a>

                        @if (Route::has('register'))
                            <a href="/user/register" class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">Patient Register</a>
                            <span class="text-gray-700">||</span>
                            <a href="/doctor/register" class="text-sm text-gray-700 dark:text-gray-500 underline">Doctor Register</a>
                        @endif
                    @endauth
                </div>
            @endif

...
function OnlineAppointment(){
    ...
    return (
        <div className="mt-20 mb-20">
            <h1 className="text-2xl text-center font-bold">Book Online Appointment</h1>
            <div className="grid md:grid-cols-4 gap-5 my-4 mx-5">
                <Calendar onDateChange={dateChange} />
                <SlotBooking timeFeed={timeGetFeed} online="yes" currentDate={date} otherDateApp={otherAppointments} />

...
const OfflineDoctorAppointments = (props) => {
                ...
                <div className="mb-5">
                    <div className="sm:ml-80 border-1 border-black bg-white w-1/3 rounded-lg">
                        <div className="mx-3 mt-3 mb-3">
                            ...
                            <button onClick={() => {window.location.href="/doctor/create-report/" + props.id}} className="py-1 px-3 mx-32 bg-orange-500 justify-center hover:bg-orange-400 focus:ring-orange-400 focus:ring-offset-orange-400 text-white w-36 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg">Create Report</button>
                        </div>
                    </div>
                </div>
            </div>
...
export default OfflineDoctorAppointments;